...
import com.sparrho.supperdemo.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("com.sparrho.supperdemo.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("com.sparrho.supperdemo.InitActivity");
                    } catch (ClassNotFoundException e) {
                        Log.e(TAG, "Failed loading InitActivity", e);
                    }
